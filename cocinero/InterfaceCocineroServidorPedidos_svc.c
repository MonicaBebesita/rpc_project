...
static void
cocineropedidos_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	union {
		int registrar_cocinero_1_arg;
		int notificar_pedido_terminado_1_arg;
	} argument;
	char *result;
	...
	case notificar_pedido_terminado:
		_xdr_argument = (xdrproc_t) xdr_int;
		_xdr_result = (xdrproc_t) xdr_bool;
		local = (char *(*)(char *, struct svc_req *)) notificar_pedido_terminado_1_svc;
		break;
